  ...
  const getStatusDisplay = () => {
    if (isIdentityVerified) {
      return {
        ...
        description: 'Your identity has been verified. You can complete business purchases.'
      }
    }
    ...
    return {
      ...
      color: 'text-gray-700',
      bg: 'bg-gray-50 border-gray-200',
      description: 'You only need to verify when you buy a business — after a seller accepts your offer, before you pay the deposit.'
    }
  }
        ...
        <div className="p-6">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100">
            ...
            <ul className="text-sm text-gray-500 space-y-1">
              <li>• Required only to buy a business, once the seller accepts your offer</li>
              <li>• Needed to pay the deposit, approve the deal and make the final payment</li>
              <li>• Browsing, unlocking listings, offers, messages and tools never require it</li>
              <li>• Protects sellers and keeps the marketplace trusted</li>
            </ul>
          </div>
        </div>
      </Card>
